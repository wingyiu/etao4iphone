...
@implementation ETaoLocalMenuView
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {  		
		[self addSubview:[self _getButtonTop:@"10000米" Tag:0 Frame:CGRectMake(-0.5,11,self.frame.size.width+0.5,34.5)]];
		[self addSubview:[self _getButton:@"5000米" Tag:1 Frame:CGRectMake(-0.5,44.5,self.frame.size.width+0.5,34.5)]];
		[self addSubview:[self _getButton:@"2000米" Tag:2 Frame:CGRectMake(-0.5,79.0,self.frame.size.width+0.5,34.5)]];
        [self addSubview:[self _getButton:@"1000米" Tag:3 Frame:CGRectMake(-0.5,113.5,self.frame.size.width+0.5,34.5)]];
        [self addSubview:[self _getButtonBottom:@"500米" Tag:4 Frame:CGRectMake(-0.5,148.0,self.frame.size.width+0.5,34.5)]]; 
